  ...
  return (
    <div>
        <p className="text-center py-4 text-red-500">
            Ceny podane poniżej mają charakter orientacyjny. Cena uzależniona jest 
            od stopnia zabrudzenia oraz ilości zamówienia. Ostateczną cenę można 
            poznać dzwoniąc do nas lub wysyłając zdjęcie tego co wymaga czyszczenia, 
            a nasz pracownik poda dokładną wycenę.
        </p>
